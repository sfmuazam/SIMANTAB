...
class Kelas11Controller extends Controller
{
    ...
    public function index()
    {
        ...
        if (request()->ajax()) {
            ...
            ->addColumn('kekurangan', function ($data) {
                ...
                $keluar_pribadi = Tabungan::where('id_siswa', $data->id)->where('keterangan', 'LIKE', "%Kelas 11%")->sum('keluar');
    ...
    public function store(Request $request)
    {
        ...
        return response()->json([
            'tagihan' => Tagihan::where('jenis','tagihan_kelas11')->value('nilai'),
